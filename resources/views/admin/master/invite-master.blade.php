...
@section('page-title')
    <title>Arabic Learning | Invite Master</title>
@endsection
@section('body')
    <div class="at-invitemaster">
        <div class="at-contentbox">
            <div class="at-themetitle">
                <h2>Invite Master</h2>
            </div>
            <form action="{{route('admin_store_user')}}" method="post" class="at-formtheme at-invitemasterform">
                <fieldset>
                    @csrf
