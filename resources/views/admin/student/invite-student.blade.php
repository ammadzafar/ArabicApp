...
@section('page-title')
    <title>Arabic Learning | Invite Student</title>
@endsection
@section('body')
    <div class="at-invitestudent">
        <div class="at-contentbox">
            <div class="at-themetitle">
                <h2>Invite Student</h2>
            </div>
            <form action="{{route('admin_store_user')}}" method="post" class="at-formtheme at-invitestudentform">
                <fieldset>
                    @csrf
                    <div class="at-inputholder">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{old('age')}}" name="age" placeholder="Enter Age" min="1" max="100">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn at-btn">Send Invite</button>
                        </div>
                    </div>
                </fieldset>
            </form>
