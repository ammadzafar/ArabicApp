                    ...
                    <table class="table">
                        ...
                        @forelse($recordings as $key => $recording)
                            <tr id="user-3">
                                ...
                                <td data-title="Id"><figure><img src="{{$recording->masterVoice ? asset('uploads/alphabets/'.$recording->masterVoice->alphabet->alphabet) : ''}}"></figure></td>
                                <td data-title="Id">
                                    <audio controls>
